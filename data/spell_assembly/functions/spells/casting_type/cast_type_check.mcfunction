...
function spell_assembly:spells/particles/validate_particles with storage spell_assembly:temp data
...
$function spell_assembly:spells/casting_type/$(Type) with storage spell_assembly:spells Spells[{ID:$(SelectedSpellID)}]
